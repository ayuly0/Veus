...
class Logger:
	...
	def set_username(self, username: Union[Any, str]):
	...
	def debug(self, message: Union[Any, str]) -> None:
		if self._debug:
	...
	def info(self, message: Union[Any, str]) -> None:
		print(
	...
	def warn(self, message: Union[Any, str]) -> None:
	...
	def success(self, message: Union[Any, str]) -> None:
		print(
	...
	def fail(self, message: Union[Any, str]) -> None:
		print(
	...
	def error(self, message: Union[Any, str], exc=False) -> None:
		if exc:
	...
	def critical(self, message: Union[Any, str], exc=False) -> None:
		if exc:
